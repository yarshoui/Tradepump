...
SELECT 1, operation_id FROM access.operations
;

--
-- Dumping data for table `country`
--
INSERT INTO public.countries(country_id, country_iso, country_name, country_iso3, country_numcode, country_phonecode) VALUES
...
(29, 'BV', 'Bouvet Island', 'BVT', 74, 0),
(30, 'BR', 'Brazil', 'BRA', 76, 55),
(31, 'IO', 'British Indian Ocean Territory', 'IOT', 86, 246),
...
(45, 'CX', 'Christmas Island', 'CXR', 162, 61),
...
(61, 'DO', 'Dominican Republic', 'DOM', 214, 1),
...
(76, 'TF', 'French Southern Territories', 'ATF', 260, 0),
...
(93, 'HM', 'Heard Island and Mcdonald Islands', 'HMD', 334, 0),
...
(126, 'MK', 'North Macedonia', 'MKD', 807, 389),
...
(176, 'RO', 'Romania', 'ROU', 642, 40),
(177, 'RU', 'Russian Federation', 'RUS', 643, 7),
...
(198, 'GS', 'South Georgia and the South Sandwich Islands', 'SGS', 239, 0),
...
(212, 'TL', 'Timor-Leste', 'TLS', 626, 670),
...
(219, 'TM', 'Turkmenistan', 'TKM', 795, 993),
...
(227, 'UM', 'United States Minor Outlying Islands', 'UMI', 581, 1),
...
(240, 'ME', 'Montenegro', 'MNE', 499, 382),
(241, 'XK', 'Kosovo', 'XKX', 0, 383),
(242, 'AX', 'Aland Islands', 'ALA', 248, 358),
(243, 'BQ', 'Bonaire, Sint Eustatius and Saba', 'BES', 535, 599),
(244, 'CW', 'Curacao', 'CUW', 531, 599),
(245, 'GG', 'Guernsey', 'GGY', 831, 44),
(246, 'IM', 'Isle of Man', 'IMN', 833, 44),
(247, 'JE', 'Jersey', 'JEY', 832, 44),
(248, 'BL', 'Saint Barthelemy', 'BLM', 652, 590),
(249, 'MF', 'Saint Martin', 'MAF', 663, 590),
(250, 'SX', 'Sint Maarten', 'SXM', 534, 1),
(251, 'SS', 'South Sudan', 'SSD', 728, 211)
;
