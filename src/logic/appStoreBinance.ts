 ...
 import { subscribeToBinanceCurrencyPair, setBinanceDataHandler, /*getBinanceSocket*/ } from 'src/logic/binanceRest';
...
//console.log ('bit1', binanceOrdersDataArr);
 ...
 export class AppStoreBinance {
    ...
    setOrderQuantity = debounce((input: string) => {//Need to rename setOrderQuantity for Binance
